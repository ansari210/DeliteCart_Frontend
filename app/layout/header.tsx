    ...
    <header className="bg-[#f7f4f4] sticky">
      <div className="container mx-auto flex items-center justify-between py-4 ">
        ...
        <div className="flex items-center space-x-6">
          ...
          }}> <Search height={30} weight={30} color="black" /></i>}
             {open && (
        <input
          ref={inputRef}
          type="text"
        ...
        />
          ...
          <Link href="/user/signin" className="cursor-pointer relative text-sm text-[#000] font-medium hover:after:w-full after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:bg-orange-500 after:w-0 after:transition-all after:duration-300">
            SIGN IN
          </Link>
        </div>
      </div>
